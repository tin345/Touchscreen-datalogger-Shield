...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
void OneWireStartConversion(void)
{
    ds.reset();           // Reset  DS18B20
    ds.write(0xCC);       // Skip_ROM, to initate communication with all devices on One Wire
    ds.write(0x44);       // start conversion (all devices)
